  ...
  return (dispatch, getState) => {
    ...
    if (crystalBoardSelectors.selectBoardStatus(state) === BoardStatus.CRYSTAL_CHAINS_RESOLVED) {
      if (crystalBoardSelectors.isBoardFilled(state)) {
        ...
        // don't generate a new preview, because the moving-crystals are out
        // of the visible area and the player can't see the crystals if the 
        // preview is updated to early
