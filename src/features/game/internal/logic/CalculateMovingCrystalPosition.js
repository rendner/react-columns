...
import {constants as movingCrystalConstants}
  from '../../../../domains/moving-crystals';
import {constants as gameStatusConstants}
...
const LAST_VALID_Y_POS =
  crystalFeatureConstants.CELL_SIZE * (crystalBoardConstants.ROW_COUNT - 1);
...
const calculateNewYPosition = (matrix, position, speedLevel) => {
  let movedDistance = 2 + Math.floor(
      gameStatusConstants.MAX_SPEED_LEVEL *
      Easing.easeInQuad(speedLevel / gameStatusConstants.MAX_SPEED_LEVEL));
